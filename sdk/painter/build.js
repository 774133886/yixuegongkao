...
function optimize(source) {
  ...
  var startIndex = source.indexOf('var _typeof = typeof Symbol')
  var endCode = 'Symbol.prototype ? "symbol" : typeof obj;'
  var endIndex = source.indexOf(endCode) + endCode.length + 3 // 包括换行符加 };
...
function build(file) {
  ...
  var source = optimize(readFile(file))
